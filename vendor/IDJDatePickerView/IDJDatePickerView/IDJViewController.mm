...
- (void)viewDidLoad
{
    ...
    NSLog(@"ChineseCalendarDB %d",ChineseCalendarDB::GetLeapMonth(2012));
    
    
    NSLog(@"ChineseCalendarDB %d",ChineseCalendarDB::GetYearMonths(2012));
    
    
    
    NSLog(@"ChineseCalendarDB %d",ChineseCalendarDB::GetMonthDays(2012, 12));
