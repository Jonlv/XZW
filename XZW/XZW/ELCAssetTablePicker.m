...
- (void)viewDidLoad
{
    ...
    totalSelectd =  [[NSUserDefaults standardUserDefaults] integerForKey:@"uploadLimit"];
...
//        UIBarButtonItem *doneButtonItem = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(doneAction:)] autorelease];
        ...
        UIBarButtonItem *doneButtonItem = [[UIBarButtonItem alloc]   initWithTitle:@"上传" style:UIBarButtonItemStyleDone target:self action:@selector(doneAction:)];
...
- (void)assetSelected:(id)asset
{
    ...
    [[NSUserDefaults standardUserDefaults] setInteger:totalSelectd forKey:@"uploadLimit" ];
