//
//  XZWFriendBirthdayViewController.m
//  XZW
//
...
@interface XZWFriendBirthdayViewController (){
...
@implementation XZWFriendBirthdayViewController
...
-(void)initView{
    ...
    vistorsView = [[XZWNearByFriendsView alloc]  initWithFrame:CGRectMake(0, 0, 320, TotalScreenHeight -64 ) andLinkString:XZWBirthdayList];
