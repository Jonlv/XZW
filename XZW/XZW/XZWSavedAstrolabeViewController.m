	...
	[queue inDatabase: ^(FMDatabase *db) {
	    ...
	    while ([rs next]) {
	        [saveArray addObject:[NSDictionary dictionaryWithObjectsAndKeys:
                                  [NSString stringWithFormat:@"%d", [rs intForColumn:@"id"]], @"id",
                                  [rs stringForColumn:@"name"], @"name",
                                  [rs stringForColumn:@"year"], @"year",
                                  [rs stringForColumn:@"month"], @"month",
                                  [rs stringForColumn:@"day"], @"day",
                                  [rs stringForColumn:@"hour"], @"hour",
                                  [rs stringForColumn:@"minute"], @"minute",
                                  [rs stringForColumn:@"daylight"], @"daylight",
                                  [rs stringForColumn:@"timezone"], @"timezone",
                                  [rs stringForColumn:@"longitude"], @"longitude",
                                  [rs stringForColumn:@"latitude"], @"latitude",
                                  [rs stringForColumn:@"am"], @"am",
                                  [rs stringForColumn:@"sml"], @"sml",
                                  [rs stringForColumn:@"birthday"], @"birthday",
                                  [rs stringForColumn:@"locString"], @"locString",
                                  [rs stringForColumn:@"timezoneString"], @"timezoneString", nil]];
		}
