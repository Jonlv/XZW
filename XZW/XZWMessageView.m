...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [(UIImageView*)[cell.contentView viewWithTag:334]  setImageWithURL:[NSURL URLWithString: [[[messageArray  objectAtIndex:indexPath.row] objectForKey:@"avatar"]  description]]];
     
    [(UILabel*)[cell.contentView viewWithTag:3335]  setText:[[[messageArray  objectAtIndex:indexPath.row] objectForKey:@"uname"]  description]];
    
    [(UILabel*)[cell.contentView viewWithTag:3336]  setText:[[[messageArray  objectAtIndex:indexPath.row] objectForKey:@"last_message"]  description]];
    
    //
    UILabel *dynUL = (UILabel *)[cell.contentView viewWithTag:991];
    dynUL.hidden = true;
