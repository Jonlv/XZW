    ...
    profileRequest = [XZWNetworkManager asiWithLink:!isNotSelf?XZWUserInfo:[XZWUserInfo stringByAppendingFormat:@"&uid=%d",userID] postDic:nil completionBlock:^{
        ...
        if ([[responseDic  objectForKey:@"status"]  intValue] == 0) {
            ...
            if (!isNotSelf) {
                ...
                userID = [[[responseDic  objectForKey:@"data"] objectForKey:@"uid"]   intValue];
                
                [[NSUserDefaults standardUserDefaults]   setObject:[[responseDic  objectForKey:@"data"] objectForKey:@"uid"]forKey:@"userID"];
                 
                [[NSUserDefaults standardUserDefaults]   setObject:[[responseDic  objectForKey:@"data"] objectForKey:@"uname"]forKey:@"username"];
                
                [[NSUserDefaults standardUserDefaults]   setObject:[[responseDic  objectForKey:@"data"] objectForKey:@"avatar"] forKey:@"avatar"];
                
                [ [NSUserDefaults standardUserDefaults]  setObject:[[responseDic  objectForKey:@"data"] objectForKey:@"constellation"] forKey:@"constellation"];
