//
//  XZWKnowledgeCollectionViewController.m
//  XZW
//
...
@interface XZWKnowledgeCollectionViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation XZWKnowledgeCollectionViewController
...
-(id)initKnowledgeArray:(NSArray*)collectionArray{
    
    self = [super init];
    if (self) {
        
        
        knowArray = [[NSMutableArray alloc]  initWithArray:collectionArray];
        
       
        
        
        UILabel *zodiacUL = [[UILabel alloc]  initWithFrame:CGRectMake(8, 5, 310, 25)];
        zodiacUL.text = [NSString stringWithFormat:@"%@  ",@"我的收藏"  ];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [(UILabel *)[cell.contentView viewWithTag:3336]   setText: [XZWUtil filterHTML:knowArray[indexPath.row][@"art_description"]  ] ];
