...
+ (void)dismiss
{
	...
	if ([sharedDialog respondsToSelector:@selector(presentingViewController)]){
        ...
        if ([[sharedDialog presentingViewController] respondsToSelector:@selector(dismissModalViewControllerAnimated:)]){
            [[sharedDialog presentingViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:true]];
        }else {
        ...
        if ([[sharedDialog parentViewController] respondsToSelector:@selector(dismissModalViewControllerAnimated:)]){
            [[sharedDialog parentViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:true]];
        }else {
            
            [[sharedDialog parentViewController]
             dismissViewControllerAnimated:true completion:nil];
        }
    }
...
- (void)dismiss
{
	if (self == sharedDialog) {
		...
		if ([self respondsToSelector:@selector(presentingViewController)]){
            ...
            if ([[self presentingViewController] respondsToSelector:@selector(dismissModalViewControllerAnimated:)]){
                [[self presentingViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:true]];
            }else {
            ...
            if ([[self parentViewController] respondsToSelector:@selector(dismissModalViewControllerAnimated:)]){
                [[self parentViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:true]];
            }else {
...
- (void)show
{
    ...
    if ([[self presentingController] respondsToSelector:@selector(dismissModalViewControllerAnimated:)]){
        [[self presentingController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:true]];
    }else {
