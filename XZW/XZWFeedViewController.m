...
@interface XZWFeedViewController ()<MyFeedViewDelegate,MyFriendFeedViewDelegate>{
    ...
    XZWMyFeedView *feedView ;
    XZWMyFriendFeedView *friendFeedView;
    XZWMyFriendFeedView *myDynView;
...
- (void)initView{
    ...
    feedView = [[XZWMyFeedView alloc]  initWithFrame:CGRectMake(0, 44, 320, TotalScreenHeight - 108 ) andLinkString:XZWGetDtinfo];
    feedView.delegate = self;
    [self.view addSubview:feedView];
    [feedView release];
    
    myDynView =[[XZWMyFriendFeedView alloc]  initWithFrame:CGRectMake(0, 44, 320, TotalScreenHeight - 108 ) andLinkString:XZWMyDt];
    myDynView.delegate = self;
    [self.view addSubview:myDynView];
    [myDynView release];
    
    
    
    friendFeedView =[[XZWMyFriendFeedView alloc]  initWithFrame:CGRectMake(0, 44, 320, TotalScreenHeight - 108 ) andLinkString:XZWFriendDt];
    friendFeedView.delegate = self;
    [self.view addSubview:friendFeedView];
    [friendFeedView release];
...
-(void)friendFeed{
    ...
    [self.view bringSubviewToFront:friendFeedView];
...
-(void)myFeed{
    ...
    [self.view bringSubviewToFront:myDynView];
