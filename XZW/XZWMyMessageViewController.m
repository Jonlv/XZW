...
-(void)clickMessageIndex:(NSDictionary*)messageDic{
    ...
    if (![messageDic[@"list_id"]  isKindOfClass:[NSNull class]]&& ![messageDic[@"uid"] isKindOfClass:[NSNull class]]&& ![messageDic[@"uname"]  isKindOfClass:[NSNull class]] && ![messageDic[@"avatar"]  isKindOfClass:[NSNull class]]) {
